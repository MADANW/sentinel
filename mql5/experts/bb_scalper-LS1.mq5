...
int OnInit()
  {
   ...
   Print("BB Scalper EA v4.0 | BB:", BB_Period, " Dev:", BB_Deviation,
...
void OnTick()
  {
   ...
   // Signals
   bool buySignal  = touchedLower && volumeConfirmed;
   bool sellSignal = touchedUpper && volumeConfirmed;
